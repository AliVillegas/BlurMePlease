    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			add_location(img0, file, 38, 2, 896);
    			attr_dev(span0, "class", "navbar-toggler-icon");
    			add_location(span0, file, 54, 4, 1249);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*doSomeMagic*/ ctx[1], false, false, false)
    				];
